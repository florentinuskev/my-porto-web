...
const Navbar = ({ isSticky }: any) => {
    ...
    return (
        <div className={`w-full flex flex-1 flex-col md:flex-row top-0 text-white p-5 items-center border-b-2 bg-gray-600 ${isSticky ? 'sticky' : 'fixed'
            }`}>
            <div className='flex flex-1 items-center w-full justify-center'>
                ...
                <div className='border rounded p-1 ml-auto' onClick={() => setIsOpen(!isOpen)}>
            ...
            <div className={`${isOpen ? 'flex' : 'hidden'} flex-col items-center`} >
